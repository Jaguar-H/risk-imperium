export const mockData = {
  ...
  opponents: [
    ...
    { id: "3", name: "Sansa", territories: [3, 7, 11, 16, 20, 24, 30, 35, 41] },
    { id: "4", name: "Arya", territories: [4, 5, 9, 14, 18, 22, 28, 33] },
    { id: "5", name: "Rickon", territories: [13, 26, 32, 37] },
    { id: "6", name: "Bran", territories: [27, 38, 39, 42, 2, 6] },
  ],
  cards: [],
  currentPlayer: "1",
};
